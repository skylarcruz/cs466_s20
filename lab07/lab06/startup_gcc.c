...
static uint32_t pui32MainStack[64];
...
ResetISR(void)
{
    ...
    //
    // initalize static constructors from libstc++ 
    //
    //__libc_init_array();
    //
...
IntDefaultHandler(void)
{
    ...
    while(1)
    {
        assert((0, "IntDefaultHandler called"));
    }
}
